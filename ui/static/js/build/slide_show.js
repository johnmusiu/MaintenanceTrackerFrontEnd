...
"use strict";
eval("\n\nvar index = 1;\n\nfunction changeSlide(x) {\n    showSlide(index += x);\n}\n\nfunction currentSlide(x) {\n    showSlide(index = x);\n}\n\nfunction showSlide(x) {\n    var i;\n    var slides = document.getElementsByClassName('slide');\n    var dots = document.getElementsByClassName('dot');\n\n    if (x > slides.length) {\n        index = 1;\n    }\n    if (x < 1) {\n        index = slides.length;\n    }\n    for (i = 0; i < slides.length; i++) {\n        slides[i].style.display = \"none\";\n    }\n\n    for (i = 0; i < dots.length; i++) {\n        dots[i].className = dots[i].className.replace(\" active\", \"\");\n    }\n\n    slides[index - 1].style.display = \"block\";\n    dots[index - 1].className += \" active\";\n}\n\nshowSlide(1);\n\n//# sourceURL=webpack:///./ui/static/js/slide_show.js?");

/***/ }),

/***/ 1:
/*!********************************************************************!*\
  !*** multi idempotent-babel-polyfill ./ui/static/js/slide_show.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! idempotent-babel-polyfill */\"./node_modules/idempotent-babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./ui/static/js/slide_show.js */\"./ui/static/js/slide_show.js\");\n\n\n//# sourceURL=webpack:///multi_idempotent-babel-polyfill_./ui/static/js/slide_show.js?");
