...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.toast = toast;\nvar base_url = exports.base_url = \"http://127.0.0.1:5000/api/v2\";\n\nfunction toast(type, message) {\n    var toastMessage = document.createElement(\"P\");\n    if (type === \"error\") toastMessage.classList.add(\"error\");else if (type === \"success\") toastMessage.classList.add(\"success\");else toastMessage.classList.add(\"info\");\n\n    var response = document.createTextNode(message);\n\n    toastMessage.appendChild(response);\n    document.body.appendChild(toastMessage);\n}\n\n//# sourceURL=webpack:///./ui/static/js/helpers.js?");

/***/ }),

/***/ "./ui/static/js/signin.js":
/*!********************************!*\
  !*** ./ui/static/js/signin.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _helpers = __webpack_require__(/*! ./helpers */ \"./ui/static/js/helpers.js\");\n\n// onclick listenerss for login request\ndocument.getElementById('btn-signin').addEventListener('click', signin);\n\n// funtion to signin user\nfunction signin(e) {\n    e.preventDefault();\n\n    var endpoint = \"/auth/login\";\n\n    fetch(_helpers.base_url + endpoint, {\n        headers: {\n            \"content-type\": \"application/json\"\n        },\n        mode: \"cors\",\n        method: \"POST\",\n        body: JSON.stringify({\n            email: document.getElementById('email').value,\n            password: document.getElementById('password').value\n        })\n    }).then(function (response) {\n        return response.json();\n    }).then(function (res) {\n        console.log(res['access-token']);\n        if (res.message === \"Login success, welcome!\") {\n            localStorage.setItem(\"access-token\", res['access-token']);\n\n            if (res.role === \"1\") location.href = \"home-admin.html\";else if (res.role === \"2\") location.href = \"super-admin.html\";else location.href = \"home-user.html\";\n\n            toast(\"success\", res.message);\n        } else {\n            toast(\"error\", res.message);\n        }\n    });\n}\n\nfunction toast(type, message) {\n    var toastMessage = document.createElement(\"P\");\n    if (type === \"error\") toastMessage.classList.add(\"error\");else if (type === \"success\") toastMessage.classList.add(\"success\");else toastMessage.classList.add(\"info\");\n\n    var response = document.createTextNode(message);\n\n    toastMessage.appendChild(response);\n    document.body.appendChild(toastMessage);\n}\n\n//# sourceURL=webpack:///./ui/static/js/signin.js?");

/***/ }),

/***/ 4:
/*!*****************************************************!*\
  !*** multi babel-polyfill ./ui/static/js/signin.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./ui/static/js/signin.js */\"./ui/static/js/signin.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./ui/static/js/signin.js?");
